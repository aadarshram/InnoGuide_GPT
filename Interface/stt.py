...
# headers = {
#     "api-subscription-key": os.getenv("STT_API_KEY"),
# }
...
def record_audio(duration_ms):
    ...
    print("Recording...")
    audio_data = sd.rec(int(duration_s * fs), samplerate=fs, channels=1, dtype='int16')
...
def process_audio_in_chunks(input_file, chunk_length_ms=10000):
    ...
    with ThreadPoolExecutor(max_workers=min(10, len(chunk_paths))) as executor:
...
if __name__ == "__main__":
    ...
    input_audio_file = record_audio(recording_duration_ms)
